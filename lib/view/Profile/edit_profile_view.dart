...
class _EditProfileViewState extends State<EditProfileView> {
  ...
  // Function to show the confirmation dialog for deleting the photo
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: IconButton(
                      ...
                      onPressed: () {
                        Navigator.pop(context); // Close modal
                        _showDeleteConfirmation(); // Show confirmation dialog
                      },
                    ),
                  ),
                ],
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 20),
                // Edit First Name
                _buildEditableField(context, 'First Name', 'Ryan',
                    EditFirstNamePage(currentValue: 'Ryan')),
                // Edit Last Name
                _buildEditableField(context, 'Last Name', 'Wiratama',
                    EditLastNamePage(currentValue: 'Wiratama')),
                // Edit Email (diganti ke EditEmailPage)
                _buildEditableField(context, 'Email', 'RyanWirawiri@gmail.com',
                    EditEmailPage(currentValue: 'RyanWirawiri@gmail.com')),
                // Edit Password
                _buildEditableField(context, 'Password', '**********',
                    EditPasswordPage(currentValue: '**********')),
              ],
            ),
          ),
        ),
  ...
  Widget _buildEditableField(
      BuildContext context, String label, String value, Widget pageToNavigate) {
    return Padding(
